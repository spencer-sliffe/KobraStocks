...
class Stock():
    ...
    def __init__(self, ticker, interval="1d", start="2020-01-01"):
        ...
        self.training_data.drop("Datetime")
    ...
    def train_classification_model(self, model_type=0, prediction_date=5):  # This is the First two AI models
        ...
        fold1_x, fold2_x, fold1_y, fold2_y = train_test_split(self.training_data, result, test_size=0.5,
                                                              random_state=42, shuffle=False)  # splits Training data
    ...
    def train_regression_model(self, model_type=0, prediction_date=5):  # These are teh other Two AI models
        ...
        fold1_x, fold2_x, fold1_y, fold2_y = train_test_split(self.training_data, result, test_size=0.2,
                                                              random_state=42,
                                                              shuffle=False)  # splits Training data for sequential testing .8 train .2 tests
    ...
    def get_Basic_Graph(self):
        try:
            ...
            fig = make_subplots(rows=2, cols=1, shared_xaxes=True,
                                ...
                                row_width=[0.2,
                                           0.7])  # Splits the chart so we can have both price and volume on the smae chart
            ...
            fig.add_trace(go.Bar(x=chartData.index, y=chartData['Volume'], name='Volume', marker_color='blue'), row=2,
                          col=1)  # Add volume as a bar chart
            ...
            fig.update_xaxes(title_font=dict(color='#00FF00'),
                             tickfont=dict(color='#00FF00'))  # Changes text appearence
